...
static int ufsdbg_dump_health_desc(struct seq_file *file)
{
	...
	u8 desc_buf[QUERY_DESC_HEALTH_MAX_SIZE] = { 0 };
	int i;
...
#define UFS_CMD_UNKNOWN					0x00
#define UFS_CMDS_DUMP 					0x01
#define UFS_GET_PWR_MODE 				0x02
#define UFS_DUMP_HEALTH_DESCRIPTOR		0x03
#define UFS_CMD_HIST_BEGIN				0x04
#define UFS_CMD_HIST_STOP				0x05
#define UFS_CMD_QOS_ON					0x06
#define UFS_CMD_QOS_OFF					0x07
